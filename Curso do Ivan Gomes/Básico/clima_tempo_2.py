...
def getinfoweather5days(localcod):                      # Nesta função tem o código e o nome do local.
    ...
    if (r.status_code != 200):
        ...
        try:
            ...
            for dia in dailyresponse['DailyForecasts']:
                weather5days = {}
                weather5days ['max'] = dia ['Temperature']['Maximum']['Value']
                weather5days ['min'] = dia ['Temperature']['Minimum']['Value']
                weather5days ['infoweather'] = dia ['Day']['IconPhrase']
                weather5days ['dayofweek'] = dia ['EpochDate']
                info5daysweather.append(weather5days)
            return info5daysweather
        except:
            return None
...
try:
    ...
    forecast5days = getinfoweather5days (mylocation['localcod'])
    print (forecast5days)
